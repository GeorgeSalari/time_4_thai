...
private
  ...
  def sea_tour_params
    params.require(:sea_tour).permit(:duration, :tour_program, :included, :necessary, :popular, :title, :short_content, :content, :adult_price, :order_number, :child_price, {images: []})
  end
end
